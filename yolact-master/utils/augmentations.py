...
#     aug2_ = Expand(MEANS)
#     aug3_ = Expand(MEANS)
#     image_aug_whole1 = aug1_(image)
#     image_aug_whole2 = aug2_(image)
#     image_aug_whole3 = aug3_(image)
#     cv2.imwrite('Expand1.jpg', image_aug_whole1[2])
#     cv2.imwrite('Expand2.jpg', image_aug_whole2[2])
#     cv2.imwrite('Expand3.jpg', image_aug_whole3[2])