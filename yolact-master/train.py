...
#权重衰减  SDG随机梯度下降 ：调节模型复杂度对损失函数的影响，防止过拟合
...
def train():
    ...
    # graph_inputs = torch.rand(1, 3, 550, 550).type(torch.cuda.FloatTensor)
    # writer.add_graph(yolact_net, (graph_inputs,))
