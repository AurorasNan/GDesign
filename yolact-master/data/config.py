...
GUARDRAILD_CLASSES = ('guardraild',)

GUARDRAILD_LABEL_MAP = {0: 1}
...
own_dataset = dataset_base.copy({
    'name': 'My dataset',

    'train_images': './data/output_data/',
    'train_info': './data/output_data/annotations.json',

    'valid_images': './data/output_data/',
    'valid_info': './data/output_data/annotations.json',

    'has_gt': True,

    'class_names':GUARDRAILD_CLASSES,

    'label_map': GUARDRAILD_LABEL_MAP
})
...
yolact_base_config = coco_base_config.copy({
    ...
    # Dataset stuff
    'dataset': own_dataset,
    'num_classes': len(own_dataset.class_names) + 1,
...
print("class_num:")
print(own_dataset.class_names)
print(len(own_dataset.class_names))
print("num:")
